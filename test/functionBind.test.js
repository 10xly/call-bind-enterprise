...
var functionBind = require("../src/functionBind")
...
test("without a context", function (t) {
  ...
  t.test("returns properly", function (st) {
    ...
    st.same(args, [1, 2, 3], "passed arguments are correct")
    st.end()
  })
  ...
  t.test("returns properly with bound arguments", function (st) {
    ...
    st.same(args, [1, 2, 3, 4, 5, 6], "passed arguments are correct")
    st.end()
  })
...
test("with a context", function (t) {
  t.test("with no bound arguments", function (st) {
    ...
    st.same(args, [1, 2, 3], "supplies passed arguments")
    st.end()
  })
  ...
  t.test(
    ...
    function (st) {
      ...
      st.not(actualContext, expectedContext)
      st.end()
    },
  )
